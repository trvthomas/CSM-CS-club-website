function newNotification(notText, notType) {
	var colorSnackbar = 'var(--bulma-success)';
	if (notType == "error") { colorSnackbar = 'var(--bulma-danger)'; }
...
function newNotificationError() { newNotification('An error occurred', 'error'); }
